...
Plot_valuable_players <- soccer_world.df %>%
  ...
  ggplot() +
  geom_col(aes(x = Value, y = fct_reorder(Player,value), fill = Position, text = text_label)) +
  labs(
    x     = "Value (millions USD)",
    y     = "Player",
    title = "Most valuable players in top 5 European Leagues" ) +
  scale_fill_viridis_d("Value") +
...
ggplotly(Plot_valuable_players, tooltip = "text", width = 400, height = 600)
```
